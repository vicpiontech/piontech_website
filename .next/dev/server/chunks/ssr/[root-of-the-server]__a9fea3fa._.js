...
;
const metadata = {
    title: "Piontech | Coming Soon",
    description: "Piontech is crafting fluid, intelligent digital ecosystems. Join the waitlist to be among the first to experience the platform."
};
